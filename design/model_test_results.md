...
## Single vs Previous Dual Stream

Lower is better for all Chamfer metrics. On the same BEHAVE heldout protocol, the previously recorded dual-stream run is better than the single-stream baseline under both comparison views:
