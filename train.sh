...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/cointeract_shared_hoi_wan_two_stage}"
...
STAGE1_HOI_TO_RGB_SCALE="${STAGE1_HOI_TO_RGB_SCALE:-0.0}"
HOI_TO_RGB_SCALE="${HOI_TO_RGB_SCALE:-0.0}"
RGB_TO_HOI_SCALE="${RGB_TO_HOI_SCALE:-1.0}"
RUN_NAME="${RUN_NAME:-cointeract_shared_two_stage_s1_${STAGE1_FULL_ATTENTION_STEPS}_s2_${STAGE2_ASYMMETRIC_STEPS}}"
