...
TRAIN_VISUAL_EVERY="${TRAIN_VISUAL_EVERY:-1000}"
LR="${LR:-1e-4}"
...
LAMBDA_PHYS_CONTACT="${LAMBDA_PHYS_CONTACT:-0.0}"
LAMBDA_DENSE_CONTACT="${LAMBDA_DENSE_CONTACT:-0.01}"
DENSE_CONTACT_MAX_POINTS="${DENSE_CONTACT_MAX_POINTS:-512}"
...
MAIN_ARGS=(
  ...
  --lambda_dense_contact "${LAMBDA_DENSE_CONTACT}"
  --dense_contact_max_points "${DENSE_CONTACT_MAX_POINTS}"
  --lr "${LR}"
...

{
  ...
  echo "CONTACT_JOINT_INDICES=${CONTACT_JOINT_INDICES}"
  echo "LAMBDA_PHYS_CONTACT=${LAMBDA_PHYS_CONTACT}"
  echo "LAMBDA_DENSE_CONTACT=${LAMBDA_DENSE_CONTACT}"
  echo "DENSE_CONTACT_MAX_POINTS=${DENSE_CONTACT_MAX_POINTS}"
  printf 'command='
  printf '%q ' "${RUN_CMD[@]}"
  echo
} > "${LOG_FILE}"
